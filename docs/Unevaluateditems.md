...
json = "{}"
# create an instance of Unevaluateditems from a JSON string
unevaluateditems_instance = Unevaluateditems.from_json(json)
# print the JSON string representation of the object
print Unevaluateditems.to_json()

# convert the object into a dict
unevaluateditems_dict = unevaluateditems_instance.to_dict()
# create an instance of Unevaluateditems from a dict
unevaluateditems_form_dict = unevaluateditems.from_dict(unevaluateditems_dict)
```
