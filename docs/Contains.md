...
json = "{}"
# create an instance of Contains from a JSON string
contains_instance = Contains.from_json(json)
# print the JSON string representation of the object
print Contains.to_json()

# convert the object into a dict
contains_dict = contains_instance.to_dict()
# create an instance of Contains from a dict
contains_form_dict = contains.from_dict(contains_dict)
```
