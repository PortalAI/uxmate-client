...
json = "{}"
# create an instance of Contentschema from a JSON string
contentschema_instance = Contentschema.from_json(json)
# print the JSON string representation of the object
print Contentschema.to_json()

# convert the object into a dict
contentschema_dict = contentschema_instance.to_dict()
# create an instance of Contentschema from a dict
contentschema_form_dict = contentschema.from_dict(contentschema_dict)
```
