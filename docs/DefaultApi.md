...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    send_new_message_request = openapi_client.SendNewMessageRequest() # SendNewMessageRequest | 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.DefaultApi(api_client)
    create_business_and_survey_request = openapi_client.CreateBusinessAndSurveyRequest() # CreateBusinessAndSurveyRequest | 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.DefaultApi(api_client)
    create_business_request = openapi_client.CreateBusinessRequest() # CreateBusinessRequest | 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.DefaultApi(api_client)
    create_survey_request = openapi_client.CreateSurveyRequest() # CreateSurveyRequest | 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.DefaultApi(api_client)
    create_template_request = openapi_client.CreateTemplateRequest() # CreateTemplateRequest | 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.DefaultApi(api_client)
    get_or_create_survey_record_request = openapi_client.GetOrCreateSurveyRecordRequest() # GetOrCreateSurveyRecordRequest | 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.DefaultApi(api_client)
    update_business_request = openapi_client.UpdateBusinessRequest() # UpdateBusinessRequest | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.DefaultApi(api_client)
    survey_id = 'survey_id_example' # str | 
    update_survey_request = openapi_client.UpdateSurveyRequest() # UpdateSurveyRequest | 
